...
api.add_resource(
    DaysByJourney, "/api/users/<userid>/journeys/<journeyid>/days/")
api.add_resource(
    DayItem, "/api/users/<userid>/journeys/<journeyid>/days/<dayid>/")

api.add_resource(
    ImagesByDay, "/api/users/<userid>/journeys/<journeyid>/days/<dayid>/images/")
api.add_resource(
    ImageItem, "/api/users/<userid>/journeys/<journeyid>/days/<dayid>/images/<imageid>")
