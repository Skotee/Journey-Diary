...
Integer
size : 4
Id of the journey, each day is related to one journey
unique, default value, 
Foreign Key
DATE
Date
...
Integer
max size : 4
ID of the day that is linked to this image, 
one image is linked to one day 
unique,
no default value, 
Foreign Key
EXTENSION
